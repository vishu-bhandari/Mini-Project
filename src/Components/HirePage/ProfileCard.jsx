...
const ProfileCard = () => {
  ...
  const handleCouponSubmit = () => {
    // Logic to apply the coupon can go here
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-sm w-full overflow-hidden transition-all duration-300 hover:shadow-orange-500/50">
        ...
        <div className="pt-16 pb-6 px-6 text-center">
          ...
          <div className="flex justify-center space-x-4 mb-2">
            <a href="#" className="text-gray-600 hover:text-secondary transition-colors duration-300">
            ...
            <a href="#" className="text-gray-600 hover:text-secondary  transition-colors duration-300">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path fillRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c5.51 0 10-4.48 10-10S17.51 2 12 2zm6.605 4.61a8.502 8.502 0 011.93 5.314c-.281-.054-3.101-.629-5.943-.271-.065-.141-.12-.293-.184-.445a25.416 25.416 0 00-.564-1.236c3.145-1.28 4.577-3.124 4.761-3.362zM12 3.475c2.17 0 4.154.813 5.662 2.148-.152.216-1.443 1.941-4.48 3.08-1.399-2.57-2.95-4.675-3.189-5A8.687 8.687 0 0112 3.475zm-3.633.803a53.896 53.896 0 013.167 4.935c-3.992 1.063-7.517 1.04-7.896 1.04a8.581 8.581 0 014.729-5.975zM3.453 12.01v-.26c.37.01 4.512.065 8.775-1.215.25.477.477.965.694 1.453-.109.033-.228.065-.336.098-4.404 1.42-6.747 5.303-6.942 5.629a8.522 8.522 0 01-2.19-5.705zM12 20.547a8.482 8.482 0 01-5.239-1.8c.152-.315 1.888-3.656 6.703-5.337.022-.01.033-.01.054-.022a35.318 35.318 0 011.823 6.475 8.427 8.427 0 01-3.462.664z"></path>
              </svg>
            </a>
          </div>
          ...
          <div className="flex items-center justify-center mb-6">
            <input
              ...
              className="px-4 py-2 border-2 border-gray-300 rounded-lg w-2/3"
            />
            <button
              onClick={handleCouponSubmit}
              className="ml-2 bg-secondary text-white px-6 py-2 rounded-lg hover:bg-orange-700 transition-colors duration-300"
            >
              Apply
            </button>
          </div>
